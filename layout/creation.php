<html>
  ...
  <body>
    <form method="post">  <!-- FORMULAIRE POUR LA CREATION D'UN LIVRE -->                                            
...
<?php 
  ...
  // TEST QUI ENVOIE UN MESSAGE D'ERREUR SI UN DES CHAMPS DU FORMULAIRE EST VIDE 
  if ($titre == ""){
  ...
  // SI TOUS LES CHAMPS SONT REMPLIS ALORS LES DONNÉES DU NOUVEAU LIVRE INSCRIT EN METTANT À JOUR TOUTES LES BDD LIVRESAUTEURS AUTEURS LIVRES
  else{
    ...
    // LIEN QUI REDIRIGE VERS LE DASHBOARD 
