    ...
    <body> 
        ...
        <div class ="form">   
            <form method="post">                                                  
                ...
                <a href="dashboard_admin.php" text-align="center"><button style="color : #fff; background-color: #002D72" >Approuver</button></a>
            </form>
        </div>
    </body>
</html>
...
<?php
    // LISTE LES UTILISATEURS A APPROUVER
    include('../script/utils.php');
    include('../script/bdd_users_connect.php');
    $nom = isset($_POST["nom"])? $_POST["nom"] : "";
    $sql = "UPDATE `Utilisateurs` SET `Approuve`= '1' WHERE `Nom` = '$nom' ";
    $result_search = executeQuery($connexion, $sql);
    echo "<p> Les utilisateurs à approuver:</p>";
    ...
    // AFFICHAGE TABLEAU SUIVANT LE NOMBRE DE COLONNES DE LA BDD
